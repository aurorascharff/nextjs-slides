  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center gap-6 p-8">
      ...
      <p className="text-muted-foreground max-w-md text-center text-lg">
        This is a regular page at /slides/demo1. It lives inside the slides
        layout but has its own UI — no deck chrome.
      </p>
      ...
      <SlideLink href="/slides/14">← Back to slides</SlideLink>
    </div>
  );
}
